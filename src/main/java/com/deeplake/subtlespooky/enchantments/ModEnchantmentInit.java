package com.deeplake.subtlespooky.enchantments;
...
public class ModEnchantmentInit {
    ...
    //Example Enchant
//    public static final ModEnchantmentBase ANTI_VANILLA = new ModEnchantmentBase("subtlespooky.anti_vanilla", Enchantment.Rarity.UNCOMMON, EnumEnchantmentType.WEAPON,  mainHand)
