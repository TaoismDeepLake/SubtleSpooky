...
import com.deeplake.subtlespooky.item.IGuaEnhance;
import com.deeplake.subtlespooky.item.ItemSwordBase;
import com.deeplake.subtlespooky.util.CommonDef;
import com.deeplake.subtlespooky.util.IDLGeneral;
...
//    public com.deeplake.subtlespooky.item.skills.martial.BuffTuple GetWaterBuff(ItemStack stack)
//    {
//        int water = GetGuaEnhance(stack, 2);
//        return new com.deeplake.subtlespooky.item.skills.martial.BuffTuple(water / 4, TICK_PER_SECOND * water * 2);
//    }
//
//    public com.deeplake.subtlespooky.item.skills.martial.BuffTuple GetMountainBuff(ItemStack stack)
//    {
//        int gua = GetGuaEnhance(stack, 4);
//        return new com.deeplake.subtlespooky.item.skills.martial.BuffTuple(gua / 4, TICK_PER_SECOND * gua * 2);
//    }
//
