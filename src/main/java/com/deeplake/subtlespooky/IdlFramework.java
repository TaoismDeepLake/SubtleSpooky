package com.deeplake.subtlespooky;

import com.deeplake.subtlespooky.gui.ModGuiElementLoader;
import com.deeplake.subtlespooky.init.ModConfig;
import com.deeplake.subtlespooky.init.ModRecipes;
import com.deeplake.subtlespooky.init.ModSpawn;
import com.deeplake.subtlespooky.init.RegistryHandler;
import com.deeplake.subtlespooky.keys.KeyboardManager;
import com.deeplake.subtlespooky.meta.MetaUtil;
import com.deeplake.subtlespooky.network.NetworkHandler;
import com.deeplake.subtlespooky.proxy.ProxyBase;
...
public class IdlFramework {
    ...
    public void preInit(FMLPreInitializationEvent event) {
        ...
        if (Reference.CLIENT_PROXY_CLASS.indexOf("deeplake.subtlespooky.proxy.ClientProxy") > 0)
        {
