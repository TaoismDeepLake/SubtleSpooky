...
import com.deeplake.subtlespooky.item.skills.ItemSkillBase;
    ...
    public static void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag flag,
        ...
        if (shiftPressed)
        {
            ...
            if (showGuaSocketDesc)
            {
                ...
                if (guaTotal > 0)
                {
                    tooltip.add(I18n.format("subtlespooky.gua_enhance_list.desc", GetGuaEnhanceString(stack, 0),
            ...
            tooltip.add(TextFormatting.AQUA +  I18n.format("subtlespooky.shared.press_shift"));
            if (use_flavor)
            {
