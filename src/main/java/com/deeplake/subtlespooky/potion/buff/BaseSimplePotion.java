package com.deeplake.subtlespooky.potion.buff;
...
public class BaseSimplePotion extends Potion {
    protected static final ResourceLocation resource = new ResourceLocation("subtlespooky","textures/misc/potions.png");
...
//    }
    ...
    public BaseSimplePotion(boolean isBadEffectIn, int liquidColorIn, String name, int icon) {
        ...
        setPotionName("subtlespooky.potion." + name);
        iconIndex = icon;
    }
