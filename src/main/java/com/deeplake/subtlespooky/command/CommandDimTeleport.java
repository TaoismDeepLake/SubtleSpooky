...
import com.deeplake.subtlespooky.util.Teleport;
...
public class CommandDimTeleport extends CommandBase {
    ...
    public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException {
        ...
        }catch (NumberFormatException e)
        {
            ...
            {
                CommonFunctions.SendMsgToPlayerStyled((EntityPlayerMP) sender, "subtlespooky.msg.dim_id_invalid", TextFormatting.RED, s);
            }
            return;
        }
